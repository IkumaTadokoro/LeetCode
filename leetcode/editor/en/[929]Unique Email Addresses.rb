...
#
#
#Input: emails = ["test.email+alex@leetcode.com","test.e.mail+bob.cathy@
#leetcode.com","testemail+david@lee.tcode.com"]
#Output: 2
...
#
# Related Topics Array Hash Table String 👍 1709 👎 242
...
def num_unique_emails(emails)
  emails
    .map { |email| email[0, email.index(/[+@]/)].gsub('.', '') + email[email.index('@')..-1] }
    .uniq
    .size
end
